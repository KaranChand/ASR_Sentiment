...
for language in ['english','italian','spanish']:
    filename = "transcription_emotion_"+language+".csv"
    transcriptions = pd.read_csv("output/text2emotion/"+filename, sep=";")
    ...
    transcriptions = transcriptions.replace({"model_emotion_nowhisper": mapping})
